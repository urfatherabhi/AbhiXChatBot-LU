...
from AbhiXChat.modules.helpers import (
    CLOSE_BTN,
    DEV_OP,
    HELP_BTN,
    HELP_BUTN,
...
@AbhiXChat.on_cmd(["start", "aistart"])
async def start(_, m: Message):
    if m.chat.type == ChatType.PRIVATE:
        ...
        await m.reply_photo(
            ...
            caption=f"""**๏ ʜᴇʏ, ɪ ᴀᴍ {AbhiXChat.name}**\n**➻ ᴀɴ ᴀɪ ʙᴀsᴇᴅ ᴄʜᴀᴛʙᴏᴛ.**\n**──────────────**\n**➻ ᴜsᴀɢᴇ /chatbot [ᴏɴ/ᴏғғ]**\n<b>||๏ ʜɪᴛ ʜᴇʟᴘ ʙᴜᴛᴛᴏɴ ғᴏʀ ʜᴇʟᴘ||</b>""",
...
@AbhiXChat.on_cmd("help")
async def help(client: AbhiXChat, m: Message):
    if m.chat.type == ChatType.PRIVATE:
...
@AbhiXChat.on_message(filters.new_chat_members)
